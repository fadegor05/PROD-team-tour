...
async def get_meetings_by_date_and_agent(session: AsyncSession, date: datetime, agent: Agent) -> List[Meeting]:
    min_datetime = datetime(date.year, date.month, date.day, 0, 0, 0)
